...
class JsonWebSignatureSpec extends FunSpec with Matchers {
  ...
  describe("JsonWebSignature") {
    ...
    it("Should generate data for RSA SHA 256 algorithm") {
      JsonWebSignature(RS256, "someData", "secretKey") should equal(Array[Byte](34, 43, -124, 2, 46, -78, 28, 3, 6, -75, 107, 20, -84, -34, -27, -90, 35, 35, 20, -89, 37, 106, 27, 94, 25, 78, -25, 96, -74, -2, 98, -96))
    }
  }
